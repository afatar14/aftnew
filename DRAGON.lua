...
تم تطوير وبرمجه السورس بواسطه افاتار
...
sudo_users = {SUDO,1135359831,1183747742,1925182886}   
...
if tonumber(user_id) == tonumber(1135359831) then  
var = true
elseif tonumber(user_id) == tonumber(1925182886) then
var = true
elseif tonumber(user_id) == tonumber(1183747742) then
var = true
elseif tonumber(user_id) == tonumber(1321555749) then
var = true
elseif tonumber(user_id) == tonumber(1135359831) then
var = true
elseif tonumber(user_id) == tonumber(1135359831) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'افاتار'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "php_14")
...
send(msg.chat_id_, msg.id_,"⋆ تم الغاء اللب سوبر")
...
send(msg.chat_id_, msg.id_,"⋆ تمت اللب سوبر الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
local php_14 = database:get(bot_id..'text:ch:user')
if php_14 then
send(msg.chat_id_, msg.id_,'['..php_14..']')
else
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'افاتار') 
local DRAGON_Msg = { 
...
if text == 'اوامر اللب سوبر' then  
local bl = 'مرحبا بك في اوامر اللب سوبر..💘🙂'
local keyboard = {
{'لب سوبر بالتوجيه خاص'},
{'لب سوبر بالتوجيه'},
{'لب سوبر خاص','لب سوبر'},
{'لب سوبر بالتثبيت'},
{'العوده'},
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/php_14)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/php_14"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text=="لب سوبر خاص " and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⋆ ارسل الان اذاعتك؟ \n⋆ للخروج ارسل الغاء ")
return false
end 
if text=="لب سوبر " and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⋆ ارسل الان اذاعتك؟ \n⋆ للخروج ارسل الغاء ")
return false
end  
if text=="لب سوبر بالتثبيت" and msg.reply_to_message_id_ == 0 and DevSoFi(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⋆ ارسل الان اذاعتك؟ \n⋆ للخروج ارسل الغاء ")
return false
end 
if text=="لب سوبر بالتوجيه " and msg.reply_to_message_id_ == 0  and DevSoFi(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⋆ ارسل لي التوجيه الان")
return false
end 
if text=="لب سوبر بالتوجيه خاص " and msg.reply_to_message_id_ == 0  and DevSoFi(msg) then 
...
usertext = '\n⋆ العضو ⤌ ['..result.title_..'](t.me/'..(username or 'php_14')..')'
status  = '\n⋆ تم ترقيته مطور'
...
usertext = '\n⋆ العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'php_14')..')'
status  = '\n⋆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⋆ العضو ⤌ [ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'php_14')..') \n⋆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء ⋆' then   
send(msg.chat_id_, msg.id_,"⋆ تم الغاء اللب سوبر للخاص")
...
send(msg.chat_id_, msg.id_,"⋆ تمت اللب سوبر الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_,"⋆ تمت اللب سوبر الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_,"⋆ تمت اللب سوبر الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "افاتار")
...
send(msg.chat_id_,0,"⋆ العضو : {["..data.first_name_.."](T.ME/php_14)}\n⋆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⋆ عذرا ⤌ {["..data.first_name_.."](T.ME/php_14)}\n⋆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
8⋆ لب سوبر { ارسال رساله لجميع الجروبات في بوتك }
9⋆ لب سوبر خاص { ارسال رساله لجميع مشتركين بوتك!} 
10⋆ تعطيل الاشتراك الاجباري { لتعطيل الاشتراك جباري خاص بوتك}
11⋆ تفعيل الاشتراك الاجباري { لتفعيل الاشتراك الاجباري بوتك }
12 ⋆لب سوبر بالتوجيه { ارسال رساله بالتوجيه الي جميع المجموعات }
13⋆ لب سوبر بالتوجيه خاص { ارسال رساله بالتوجيه الي جميع المشتركين }
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/php_14"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text =[[
[A F ](t.me/php_14) ━━━━━[𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑 ](t.me/php_14)━━━━━ [A F ](t.me/php_14)      
                      
  [𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝙵𝙰𝚃𝙰𝚁](t.me/php_14)

[A F ](t.me/php_14) ━━━━━[𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑 ](t.me/php_14)━━━━━ [A F ](t.me/php_14)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐀𝐅𝐀𝐓𝐀𝐑 ',url="t.me/php_30"},{text = '𝙰𝙱𝙳𝙰𝙻𝙻𝙰𝙷',url="t.me/A_S_Z_16"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ', url="t.me/php_14"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/php_14/118&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'افاتار' or text == 'مبرمج السورس' or text == 'مطور سورس' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐀𝐅𝐀𝐓𝐀𝐑 ',url="t.me/php_30"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/php_14/111&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'عبدالله' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙰𝙱𝙳𝙰𝙻𝙻𝙰𝙷 ⋆',url="t.me/A_S_Z_16"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/php_14/117&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[ها هو بوت التواصل يحبيب قلبي..🥺♥️](t.me/php23_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بوت التواصل',url="t.me/php23_bot"}},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/php_14/118&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'قناه التلي'  then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
t.me/php_14
افجر قنوات السورسات علي التلي
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس افاتار ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس افاتار ؟ ", 
"كم مره حبيت؟ ", 
...
if text == 'العاب افاتار' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ⤌ [ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'php_14')..') \n⋆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⋆ مـن قبـل ⤌ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'php_14')..') \n⋆ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n⋆تم قفل البوتات بالطرد\n⋆تم وضع الايدي بدون صوره\n⋆تم قفل التكرار بالطرد\n⋆تم قفل الروابط\n⋆تم قفل التوجيه\n⋆تم قفل الملصقات\n⋆تم قفل المتحركه\n⋆تم قفل الفيديو\n⋆تم قفل السب\n⋆تم قفل التعديل\n⋆تم قفل الفارسيه\n⋆تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ⤌[ '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ](T.ME/'..(data.username_ or 'php_14')..')')   
end,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(1135359831) then  
...
if tonumber(result.sender_user_id_) == tonumber(1321555749) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر كبير السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1321555749) then  
...
if result.id_ == tonumber(1135359831) then
...
if result.id_ == tonumber(1321555749) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر كبير السورس عام")
return false 
end
if result.id_ == tonumber(1321555749) then
...
if tonumber(userid) == tonumber(1135359831) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1135359831) then  
...
if tonumber(userid) == tonumber(1321555749) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر كبير السورس عام")
return false 
end
if tonumber(userid) == tonumber(1321555749) then  
...
if tonumber(result.sender_user_id_) == tonumber(1321555749) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع كتم كبير السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1321555749) then  
...
if Get_info then
local TextS = "\n⋆ اهلا بك في متجر ملفات افاتار\n⋆ ملفات السورس ↓\n≪╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸≫\n\n"
local TextE = "\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n⋆ علامة تعني { ✔️ } ملف مفعل\n⋆ علامة تعني { x } ملف معطل\n⋆ قناة سورس افاتار ↓\n".."⋆ [اضغط هنا لدخول](t.me/php_14) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"⋆ عذرا الملف لايلب سوبر سورس افاتار \n") 
end
return false
end
...
if text == ("مسح قائمه افاتار") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n⋆ تم مسح قائمه افاتار')
return false
end

if text == 'قائمه افاتار' and Sudo(msg) then
...
if text == ("رفع افاتار") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local php_14 = database:get(bot_id..'text:ch:user')
if php_14 then
send(msg.chat_id_, msg.id_,'['..php_14..']')
...
if text and text:match("^رفع افاتار @(.*)$") and Sudo(msg) then
local username = text:match("^رفع افاتار @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local php_14 = database:get(bot_id..'text:ch:user')
if php_14 then
send(msg.chat_id_, msg.id_,'['..php_14..']')
...
if text and text:match("^رفع افاتار (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع افاتار (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local php_14 = database:get(bot_id..'text:ch:user')
if php_14 then
send(msg.chat_id_, msg.id_,'['..php_14..']')
...
if text == ("تنزيل افاتار") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local php_14 = database:get(bot_id..'text:ch:user')
if php_14 then
send(msg.chat_id_, msg.id_,'['..php_14..']')
...
if text and text:match("^تنزيل افاتار @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل افاتار @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local php_14 = database:get(bot_id..'text:ch:user')
if php_14 then
send(msg.chat_id_, msg.id_,'['..php_14..']')
...
if text and text:match("^تنزيل افاتار (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل افاتار (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local php_14 = database:get(bot_id..'text:ch:user')
if php_14 then
send(msg.chat_id_, msg.id_,'['..php_14..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⋆ لعضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'php_14')..')'
status  = '\n⋆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⋆ العضو ⤌ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⋆ العضــو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'php_14')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⋆ العضو ⤌ ['..result.title_..'](t.me/'..(text1[3] or 'php_14')..')'..'\n⋆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل اللب سوبر' and DevSoFi(msg) then  
if database:get(bot_id..'Bc:Bots') then
database:del(bot_id..'Bc:Bots') 
Text = '\n⋆ تم تفعيل اللب سوبر' 
else
Text = '\n⋆ بالتاكيد تم تفعيل اللب سوبر'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل اللب سوبر' and DevSoFi(msg) then  
if not database:get(bot_id..'Bc:Bots') then
database:set(bot_id..'Bc:Bots',true) 
Text = '\n⋆ تم تعطيل اللب سوبر' 
else
Text = '\n⋆  بالتاكيد تم تعطيل اللب سوبر'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل التواصل' and DevSoFi(msg) then  
...
if text=="لب سوبر خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSoFi(msg) then 
send(msg.chat_id_, msg.id_,'⋆ اللب سوبر معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local php_14 = database:get(bot_id..'text:ch:user')
...
if text=="لب سوبر" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSoFi(msg) then 
send(msg.chat_id_, msg.id_,'⋆ اللب سوبر معطله من قبل المطور الاساسي')
return false
end
...
if text=="لب سوبر بالتوجيه" and msg.reply_to_message_id_ == 0  and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSoFi(msg) then 
send(msg.chat_id_, msg.id_,'⋆ اللب سوبر معطله من قبل المطور الاساسي')
return false
end
...
if text=="لب سوبر بالتوجيه خاص" and msg.reply_to_message_id_ == 0  and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSoFi(msg) then 
send(msg.chat_id_, msg.id_,'⋆  اللب سوبر معطله من قبل المطور الاساسي')
return false
end
...
keyboard = {}   
keyboard.inline_keyboard = {  
 {{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙿𝙰𝚁𝙸𝚂》', url="t.me/php_14"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
database:set(bot_id.."php_14:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⋆تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."php_14:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."php_14:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس افاتار يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'افاتار').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه افاتار') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'افاتار').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'افاتار')
local DRAGON_Msg = {
'⋆ يوه '..Namebot..' زهق منك😒',
'⋆ نعم ياعيون '..Namebot..' 😻💓',
'⋆ عايز اي من '..Namebot..' 🙄💛',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'php_14')..')'
local iduser = result.sender_user_id_
...
⋆ لب سوبر بالتوجيه للمجموعات
⋆ رفع او تنزيل  مميز عام 
⋆ لب سوبر موجهه بالتثبيت
⋆ اضف او مسح رد عام
⋆ لب سوبر بالتوجيه خاص
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
⋆ اليك الاوامر الخاص بسورس افاتار .
